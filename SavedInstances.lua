...
addon.svnrev = {}
addon.svnrev["SavedInstances.lua"] = tonumber(("$Revision: 552 $"):match("%d+"))
	 ...
	 for toon, ti in pairs(vars.db.Toons) do
	  if not ti.DailyResetTime or (ti.DailyResetTime < time()) then 
	    ...
	    if ti.DailyWorldQuest then
	      ...
	      if ti.level == 110 then
	      	ti.DailyWorldQuest.days2 = {}
	      	ti.DailyWorldQuest.days2.dayleft = 2
      		ti.DailyWorldQuest.days2.questneed = 0
      		ti.DailyWorldQuest.days2.questdone = 1
	      end
	    end
